...
console.log("Tổng là: " + ketQua); // Kết quả: Tổng là: 15
```
...
ví dụ:
```
// Khai báo một đối tượng chiếc xe
const chiecXe = {
  ...
  // Phương thức (Methods)
  khoiDong: function() {
    console.log("Xe đang nổ máy... vroom vroom!");
  },
  
  gioiThieu: function() {
    // Sử dụng "this" để lấy thông tin của chính đối tượng này
    console.log("Đây là chiếc xe " + this.thuongHieu + " màu " + this.mauSac);
  }
};

// Truy cập thuộc tính
console.log(chiecXe.thuongHieu); // Kết quả: VinFast

// Gọi phương thức (hành động)
chiecXe.khoiDong();  // Kết quả: Xe đang nổ máy... vroom vroom!
chiecXe.gioiThieu(); // Kết quả: Đây là chiếc xe VinFast màu Xanh dương
```
### 🔹 Array (Mảng)
